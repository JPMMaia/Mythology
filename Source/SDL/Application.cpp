...
namespace Mythology::SDL
{
    namespace
    {
        ...
        Device_memory_range allocate_device_memory(
            ...
            VkDeviceSize const allocation_size,
            VkAllocationCallbacks const* const vulkan_allocator = nullptr
        ) noexcept
        {   
        ...
        class Monotonic_device_memory_resource
        {
        public:
            ...
            ) noexcept
            {
                ...
                else
                {
                    Device_memory_range const new_device_memory_range =
                        allocate_device_memory(m_device, memory_type_index, m_blocks_size, vulkan_allocator);
        ...
        using Memory_size = VkDeviceSize;
        ...
        void allocate_node(Memory_tree& tree, Tree_node const node_to_allocate) noexcept
        {
        ...
        void free_node(Memory_tree& tree, Tree_node const node_to_free) noexcept
        {
